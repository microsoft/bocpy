...
static PyMethodDef Matrix_methods[] = {
    {"transpose", Matrix_transpose, METH_NOARGS, "transpose"},
    {"transpose_in_place", Matrix_transpose_in_place, METH_NOARGS,
     "transpose_in_place"},
    {"sum", Matrix_Sum_method, METH_VARARGS, "sum"},
    {"mean", Matrix_Mean_method, METH_VARARGS, "mean"},
    {"magnitude", Matrix_Magnitude_method, METH_VARARGS, "magnitude"},
    {"min", Matrix_Minimum_method, METH_VARARGS, "min"},
    {"max", Matrix_Maximum_method, METH_VARARGS, "max"},
    {"ceil", Matrix_Ceil_method, METH_NOARGS, "ceil"},
    {"floor", Matrix_Floor_method, METH_NOARGS, "floor"},
    {"round", Matrix_Round_method, METH_NOARGS, "round"},
    {"negate", Matrix_Negate_method, METH_NOARGS, "negate"},
    {"abs", Matrix_Abs_method, METH_NOARGS, "abs"},
    {"clip", Matrix_clip, METH_VARARGS, "clip"},
    {"copy", Matrix_copy, METH_NOARGS, "copy"},
    {"select", Matrix_select, METH_VARARGS, "select"},
    {"allclose", (PyCFunction)Matrix_allclose,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS, "allclose"},
    {"zeros", Matrix_zeros, METH_VARARGS | METH_CLASS, "zeros"},
    {"ones", Matrix_ones, METH_VARARGS | METH_CLASS, "ones"},
    {"normal", (PyCFunction)Matrix_normal,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS, "normal"},
    {"uniform", (PyCFunction)Matrix_uniform,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS, "uniform"},
    {"vector", Matrix_vector, METH_VARARGS | METH_CLASS, "vector"},
    {"concat", Matrix_concat, METH_VARARGS | METH_CLASS, "concat"},
    {NULL} /* Sentinel */
};
...
static PyGetSetDef Matrix_getset[] = {
    {"acquired", (getter)Matrix_get_acquired, NULL, "internal", NULL},
    {"rows", (getter)Matrix_get_rows, NULL, "internal", NULL},
    {"columns", (getter)Matrix_get_columns, NULL, "internal", NULL},
    {"T", (getter)Matrix_get_T, NULL, "internal", NULL},
    {"x", (getter)Matrix_get_x, (setter)Matrix_set_x, "internal", NULL},
    {"y", (getter)Matrix_get_y, (setter)Matrix_set_y, "internal", NULL},
    {"z", (getter)Matrix_get_z, (setter)Matrix_set_z, "internal", NULL},
    {"w", (getter)Matrix_get_w, (setter)Matrix_set_w, "internal", NULL},
    {"shape", (getter)Matrix_get_shape, NULL, "internal", NULL},
    {NULL} /* Sentinel */
};
...
static PyType_Spec Matrix_Spec = {.name = "boc._math.Matrix",
