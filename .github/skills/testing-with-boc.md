...
This skill describes how to write tests for code that uses the `boc` library for
...
```python
from boc import Cown, when, send, receive, TIMEOUT, wait
...
```python
from boc import send, receive, TIMEOUT
