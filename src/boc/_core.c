...
static PyMethodDef CownCapsule_methods[] = {
    ...
    {"acquired", CownCapsule_acquired, METH_NOARGS, "internal"},
    {"acquire", CownCapsule_acquire, METH_NOARGS, "internal"},
    {"release", CownCapsule_release, METH_NOARGS, "internal"},
    {NULL} /* Sentinel */
};
...
static PyGetSetDef CownCapsule_getset[] = {
    {"value", (getter)CownCapsule_get_value, (setter)CownCapsule_set_value,
     "internal", NULL},
    {"impl", (getter)CownCapsule_get_impl, NULL, "internal", NULL},
    {NULL} /* Sentinel */
};
...
void _core_module_free(void *module_ptr) {
  ...
  if (atomic_fetch_sub(&BOC_COUNT, 1) == 1) {
    PRINTDBG("All boc modules have been freed, cleaning up\n");
